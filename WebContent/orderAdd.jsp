...
<form action="" method="post">
	<h2>Dodawanie nowego zlecenia</h2>
	...
	<input type="radio" name="repairStatus" value="Zatwierdzone_koszty_naprawy" />Zatwierdzone koszty naprawy<br>
...
<input type="submit" value="Dodaj nowe zlecenie" />
</form>
